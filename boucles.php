...
// Les boucles servent à rpépéter des instructions. 

// La boucle for
    // Une valeur de départ
    // Une condition de continuiter
...
for ($i = 1; $i <= 10; $i++) {
    ...
    // $i++;
    // On peut le "lire" : affichage, intégration dans un calcul.
...
foreach ($tableau as $key => $nombre) {
    echo '<p>La valeur ' . $nombre . ' est indéxée à ' . $key . '.</p>';
}